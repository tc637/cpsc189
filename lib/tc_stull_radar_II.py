...
class Radar(object):
    """A Radar is a Nexrad WSR-88D radar."""
    
    def __init__(self,Pt,R1,b):
        """Initialize constants, make attributes for all instances of Radar."""
        self.Pt = Pt
        self.R1 = R1
        self.b = b

      
    def findPr(self,Z,K2,La,R):
       """
       ...
       """ 
       Pr=self.Pt*self.b*K2/La**2.*(self.R1/R)**2.*Z
       return Pr
    ...
    def finddbz(self,Pr,K2,La,R):
       ...
       """
       dbZ=10.*log10(Pr/self.Pt) + 20.*log10(R/self.R1) - \
           10.*log10(K2/La**2.) - 10.*log10(self.b)
       return dbZ
...
if __name__=="__main__":
    ...
    nexrad=Radar(Pt,R1,b) # grab an instance of Radar
    ...
    power_watts=nexrad.findPr(Z,K2,La,R)
    the_text="""
    ...
    La=1
    R=100.  #km
    dbZ=nexrad.finddbz(Pr,K2,La,R)
    RR=nexrad.findRR_rain(dbZ)
